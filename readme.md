# Velmie Wallet Logs Service

Logs service provides functions for logging certain events in the system.

## Wallet Logs Helm chart configuration
...
The following table lists the configurable parameters of the wallet-logs chart, and their default values.
...
| appApiPathPrefix               | API prefix path. Used with internal health check functionality.                                                                  | logs                              |
...
| nameOverride                   | Override this chart name.                                                                                                        | wallet-logs                        |
